...
EPUBJS.Reader = function (bookPath, _options) {
    ...
    this.setBookKey(this.settings.bookPath); //设置书的key，通过此key可以在今后查询到此书

    //检查本书是否之前已经保存过了，如果已经保存，则从localstorage中获取关于本书的保存信息。
    if (this.settings.restore && this.isSaved()) {
        //函数内部，检测本书的设置中是否有styles属性，如果有，则将其合并，其余的直接替换
...
//# sourceMappingURL=bookrack.js.map